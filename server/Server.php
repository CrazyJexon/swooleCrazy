...
class Server{
    ...
    public function start(){
        ...
        self::$server = $this->makeServer(
            Config::get('server.servers.type')  ,
            Config::get('server.servers.host') ,
            Config::get('server.servers.port') ,
            Config::get('server.mode') ,
            Config::get('server.servers.sock_type')  );
    ...
    protected function makeConfig(){
        return Config::get('server.settings') + [
